...
4.  Redis will not be used for live reads. Its role will be relegated to a **Write-Ahead Log (WAL)** for persistence and recovery. Events will be appended to a Redis Stream _before_ being applied to the in-memory state.
