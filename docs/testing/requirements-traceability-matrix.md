...
| -------------- | --------------------------------------------- | -------------------------------------------------------- | ------------------------------------------------------- | --------------------------------------- | ------ |
| SIT-UI-001     | Freeform text input for pulse check responses | `client/src/components/game/PulseCheckInput.tsx`         | N/A                                                     | `PulseCheckInput.test.tsx`              | ✅     |
| SIT-UI-002     | Text input with 280 character limit           | `client/src/components/game/PulseCheckInput.tsx:49`      | N/A                                                     | `PulseCheckInput.test.tsx:85`           | ✅     |
| SIT-UI-003     | Character counter display                     | `client/src/components/game/PulseCheckInput.tsx:63`      | `PulseCheckInput.test.tsx:142`                          | ✅                                      |
| SIT-UI-004     | Submit button enabled when text present       | `client/src/components/game/PulseCheckInput.tsx:55`      | N/A                                                     | `PulseCheckInput.test.tsx:111`          | ✅     |
| SIT-UI-005     | Chat input disabled during pulse check        | `client/src/components/game/ContextualInputArea.tsx:120` | N/A                                                     | `CommsPanel.test.tsx:45`                | ✅     |
| SIT-UI-006     | Phase header shows "Pulse Check - Day X"      | `client/src/components/game/CommsPanel.tsx:78`           | N/A                                                     | `CommsPanel.test.tsx:120`               | ✅     |
| SIT-UI-007     | Timer displays remaining time                 | `client/src/components/game/CommsPanel.tsx:85`           | N/A                                                     | `CommsPanel.test.tsx:140`               | ✅     |
| SIT-ACT-001    | SUBMIT_PULSE_CHECK action creation            | `client/src/hooks/useGameActions.ts:156`                 | N/A                                                     | `useGameActions.test.ts:89`             | ✅     |
| SIT-ACT-002    | Action payload validation for `string`        | N/A                                                      | `server/internal/game/player_interaction_handler.go:45` | `player_interaction_handler_test.go:23` | ✅     |
...
| NOM-ACT-001    | SUBMIT_VOTE (nomination) action | `hooks/useGameActions.ts:178`       | `server/internal/game/voting.go:123` | `voting_test.go:45`      | ✅     |
...
| VER-ACT-001    | SUBMIT_VOTE (verdict) action | `hooks/useGameActions.ts:198`    | `server/internal/game/voting.go:189`       | `voting_test.go:134`     | ✅     |
...
| NGT-ACT-001    | MINE_TOKENS action         | `hooks/useGameActions.ts:234`                  | `server/internal/game/mining.go:67`            | `mining_test.go:45`                 | ✅     |
| NGT-ACT-002    | SUBMIT_NIGHT_ACTION        | `hooks/useGameActions.ts:256`                  | `server/internal/game/role_abilities.go:89`    | `role_abilities_test.go:67`         | ✅     |
| NGT-ACT-003    | ATTEMPT_CONVERSION         | `hooks/useGameActions.ts:278`                  | `server/internal/game/night_resolution.go:123` | `night_resolution_test.go:89`       | ✅     |
...
This systematic approach prevents requirement gaps by making every feature explicit, traceable, and verifiable.
