import tokens from './src/styles/generated/tokens.json' with { type: 'json' };
    ...
    extend: {
      ...
      colors: {
        ...
        amber: {
          ...
          light: tokens.brand.accent['amber-light'],
          dark: tokens.brand.accent['amber-dark'],
        },
        cyan: {
          DEFAULT: tokens.brand.accent.cyan,
          light: tokens.brand.accent['cyan-light'],
          dark: tokens.brand.accent['cyan-dark'],
        },
        red: {
          DEFAULT: tokens.brand.accent.red,
          light: tokens.brand.accent['red-light'],
          dark: tokens.brand.accent['red-dark'],
        },
        magenta: {
          DEFAULT: tokens.brand.accent.magenta,
          light: tokens.brand.accent['magenta-light'],
          dark: tokens.brand.accent['magenta-dark'],
        },
        green: {
          DEFAULT: tokens.brand.accent.green,
          light: tokens.brand.accent['green-light'],
          dark: tokens.brand.accent['green-dark'],
        },
        blue: {
          DEFAULT: tokens.brand.accent.blue,
          light: tokens.brand.accent['blue-light'],
          dark: tokens.brand.accent['blue-dark'],
        },
