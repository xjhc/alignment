...
describe('LoginScreen', () => {
  ...
  it('has first avatar selected by default', () => {
    ...
    expect(firstAvatar).toHaveClass('border-primary', 'bg-primary')
  })
  ...
  it('allows avatar selection', async () => {
    ...
    expect(robotAvatar).toHaveClass('border-primary', 'bg-primary')
    expect(screen.getByRole('button', { name: '👤' })).not.toHaveClass('border-primary', 'bg-primary')
  })
