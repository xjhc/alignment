  ...
  return (
    <>
            ...
            <div className="bg-background-secondary/90 backdrop-blur-sm border border-border rounded-2xl p-6 mb-8 shadow-lg">
              ...
              <div className="border border-border rounded-lg overflow-hidden mb-6">
                ...
                <div className="p-4 bg-background-secondary">
                  ...
                  {activeTab === "rules" && <GameRulesSummaryEmbedded />}
                </div>
              </div>
            </div>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <span
                                ...
                                onClick={() =>
                                  setSelectedPlayerId(playerInfo.id)
                                }
                              >
                                {playerInfo.name}
                              </span>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-amber/10 border border-amber/30 rounded-xl">
                        ...
                        <p className="text-xs text-text-muted">
                          You control when the game starts and can manage
                          players
                        </p>
                      </div>
      ...
      <RoleAssignmentPreview
        ...
        playerCount={playerInfos?.length || 0}
        gameSettings={gameSettings ? { initialAlignedCount: gameSettings.initialAlignedHumanCount } : undefined}
      />
    </>
  );
}
