...
export const ExitInterviewScreen: React.FC<ExitInterviewScreenProps> = ({
  onComplete,
}) => {
  const [partingShot, setPartingShot] = useState("");
  const [isSubmitting, setIsSubmitting] = useState(false);
  const { handleSubmitPartingShot } = useGameContext();
        ...
        <div className="p-6 space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-text-muted">
              You have been eliminated from the game. Leave your mark with a
              final message.
            </p>
          </div>
          ...
          <div className="text-xs text-text-muted text-center space-y-1">
            <p>
              This message will be visible to all players for the rest of the
              game.
            </p>
